...
#ifndef SYMMETRY_ELEMENTS_IMPROPER_ROTATION_H
#define SYMMETRY_ELEMENTS_IMPROPER_ROTATION_H
...
class ImproperRotation: public Operation {
public:
    static const unsigned int DEGREE_INF = 0;  // degree for S∞ rotation
...
private:
    ...
    glm::mat3x3 rotation_reflection_matrix;
...
public:
     ...
     */
    ImproperRotation(unsigned int degree, glm::vec3 axis);
     ...
     */
    const bool equals(ImproperRotation& other) const;
...
#endif  // SYMMETRY_ELEMENTS_IMPROPER_ROTATION_H
